...
void InserirElemLP(ListaPala *LP, TPalavra item, char *, Tlista* Lista_linha ,Titem item_linha); //funcao 1
...
void ImprimirLP(ListaPala *LP, Tlista* Lista_linha); //funcao 6
